...
func init() {
	...
	modifyOrderCmd.Flags().StringP(utils.SizeFlag, "b", "", "Order size in base asset units")
	...
	modifyOrderCmd.Flags().StringP(utils.PortfolioIdFlag, "", "", "Portfolio ID. Uses environment variable if blank")
