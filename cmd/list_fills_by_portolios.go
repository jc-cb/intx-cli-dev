...
func init() {
	...
	listFillsCmd.Flags().StringP(utils.PortfolioIdFlag, "", "", "Portfolio ID(s). Uses environment variable if blank")
	listFillsCmd.Flags().StringP(utils.OrderIdFlag, "i", "", "Filter fills by order ID")
